      ...
      <Card maxW="rm">
        ...
        >
          <VStack align="stretch" spacing={2}>
              <Tag size="md"  variant='outline' colorScheme="green"  w={'100px'}>
                Оплачено
              </Tag>
            ...
            <HStack justify="space-between">
              <Button onClick={rejectHandler}  variant='outline' colorScheme="red" size="sm">
                Отменить бронь
              </Button>
            </HStack>
          </VStack>
      ...
      <Card maxW="rm">
        ...
        > 
         <Tag
              size="sm"
              variant="outline"
              colorScheme={order?.statusAccept ? "green" : "red"}
            >
          ...
          <Text mb={2}>
            {check ? (
              <>Забронировано на {order?.peoplesBooked} человек </>
            ) : (
              <>Забронировано на {order?.peoplesBooked} человека</>
            )}
          </Text>
          ...
          {/* <HStack justify="space-between"> */}
            <Button colorScheme="red" variant='outline' onClick={rejectHandler} size="sm" mb={4} ml={2}>
              Отменить бронь
            </Button>
          {/* </HStack> */}
